...
> = {
  ...
  meaning: [
    ...
    { label: 'Animation', text: 'The wall is painted tile by tile in the order the files were created. Each tile is built up in coats of paint, its name written last.' },
  ],
  params: {
